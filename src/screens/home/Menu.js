        ...
        <View>
          ...
          <View className="flex-row justify-between items-center mt-4">
            <View className="flex-row items-center">
              <Text className="text-lg font-bold" style={{ color: "#464646" }}>
                Menu
              </Text>
            </View>
            <View className="flex-row items-center">
              <View
                style={{ backgroundColor: "#FE6400" }}
          ...
          {/* SEARCH */}
          <View
            className="flex-row items-center justify-between mt-4 p-3 rounded-lg"
          ...
          >
            <TouchableOpacity
              ...
              className="h-full flex flex-col item-center justify-center"
            >
              <View
                style={{
                  flex: 1,
              ...
              >
                ...
                >
                  <View className="flex flex-col p-2 justify-center items-center">
                    ...
                    <Text
                      className="text-justify font-medium mt-1"
                      style={{ fontSize: 8, lineHeight: 10 }}
                    >
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Massa tortor, volutpat sit eget nibh pretium, hendrerit
                      posuere. Viverra scelerisque egestas ut tempor diam
                      ullamco Lorem ipsum dolor sit amet, consectetur adipiscing
                      elit. Massa tortor, volutpat sit.
                    </Text>
