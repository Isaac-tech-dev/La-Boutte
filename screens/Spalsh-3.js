...
export default function Splash_3() {
  ...
  return (
    <ScreenWrapper classname="p-4 m-4">
      ...
      <View className="p-2 m-2">
        <Image source={require('../assets/images/splash3.png')} className="items-center justify-center"/>
      </View>

      <View className="justify-center items-center p-4 mt-4">
        <Text className="text-3xl font-bold">Best App for a Foodie</Text>
        ...
        <TouchableOpacity onPress={nextNavigate} className="self-end">
          <View className="flex-row items-center mt-6 p-2">
            ...
            <Text className="ml-1 text-xs text-end" style={{color: "#FE6400"}}>Get Started</Text>
          </View>
        </TouchableOpacity>
      </View>
      </View>
