...
export default function Splash_1() {

  const navigation = useNavigation();

  const nextNavigate = () => {
    navigation.navigate("Splash2"); // Navigate to the next screen
  };
  return (
    <ScreenWrapper classname="p-4 m-4">
      ...
      <View className="p-2 m-2 ">
        <Image source={require('../assets/images/splash1.png')} className="items-center justify-center"/>
      </View>

      <View className="justify-center items-center p-4 mt-4 mx-2">
        <Text className="text-3xl font-bold">Food At Your Door Step</Text>
